...
<img src="/images/frame.gif" alt=""><br>
출처 : 나무위키


메인 스레드는 View 업데이트에 사용되기 때문에 작업량이 많아지고 딜레이가 생기면 View 업데이트가 느려지고 사용자가 느꼈을때 앱이 끊기는 것처럼 보일 수 있게 된다.
...
만약, 메인스레드가 차단된 상태가 유지되면 ANR이 발생하고 앱이 강제 종료된다.
<img src="/images/anr-sample.png" alt="">
